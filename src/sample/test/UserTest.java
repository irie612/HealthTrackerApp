...
public class UserTest {
    ...
    User user1 = new User("abcxyz", "12345");
    User user2 = new User("abcxyz", "abc@gmail.com", 180, 70);
...
//
//        Meal meal= new Meal(1000, "mealTest", Meal.MealType.BREAKFAST, 2000.0, user2.getUsername());
//        user2.addMeal(meal);
